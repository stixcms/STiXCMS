<?
	...
	$al->getAttOfNode($dbconn,$nid+0,$ATTYPE_MEDIA,$ses_userid,$ses_groupid);
...
<h2>Media<?=$nname?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<? if(is_allowed(3,$BIT_ADD) && $nid>0) { ?><a href=att_form.php?aid=0&nid=<?=$nid?>&typ=<?=$ATTYPE_MEDIA?>>[add new...]</a><? } ?></h2>
<?
...
?>	
	...
	<td><?=$al->list[$i]->title?> <? if(is_allowed(3,$BIT_MOD)) { ?><a href=att_form.php?aid=<?=$al->list[$i]->att_id?>&nid=<?=$nid?>><? } ?>[edit...]</a></td>
